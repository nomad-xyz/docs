...
function DocItemContent(props) {
	...
	const feedbackForm = (feedback) => {
		return feedback ? (
			<p className="text-lg lg:text-l text-grey-lighter">
			...
			>
				...
				<div className="flex mt-6">
					...
					>
						<GoThumbsup
							className={`w-6 h-6 flex-1 justify-items-auto fill-current text--lighter transform transition group-hover:scale-125 group-active:scale-125 ${
				...
				>
					...
					{(!!formData.thumb || !!formData.feedback) && (
						<div className="opacity-0 group-hover:opacity-100 transition absolute z-0 inset-0 bg-gradient-to-r from-grey to-grey-lighter rounded" />
					)}
				</button>
								...
								<div className="flex flex-wrap">
									...
									<div className="flex-1 p-2">
										...
										<ul className="text-sm">
											<li>
												Join our{' '}
												<Link to="https://discord.gg/nomadxyz">
												  Discord
												</Link>
											</li>
</ul>
									...
									<div className="flex-1 pl-2 pt-2">
										...
										<ul className="text-sm">
											...
											<li>
												Submit a{' '}
												<Link to="https://github.com/nomad-xyz/monorepo/issues/new?assignees=&labels=T-feature&template=FEATURE-FORM.yml">
													feature request 🌉
												</Link>
											</li>
										</ul>
